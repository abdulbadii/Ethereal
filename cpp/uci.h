...
inline int numberIn(string& s);
inline char* numberIn(string&, char*);
inline bool strStartsWith(string& str, const char* key);
inline const char* strContains(string& str, const char* key);
inline const char* strContains(string& str, const char* key, size_t& len);
